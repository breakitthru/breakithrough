...
const TABS = [
  { label: "SOS log", href: "/admin/safety" },
  { label: "On-call & escalation", href: "/admin/safety/on-call" },
];
...
export function SafetyTabs() {
  ...
  return (
    <div className="mb-6 flex flex-wrap gap-1 border-b border-[var(--color-line)]">
      {TABS.map((t) => {
        const active = t.href === "/admin/safety" ? pathname === "/admin/safety" || pathname.startsWith("/admin/safety/event") : pathname.startsWith(t.href);
        return (
