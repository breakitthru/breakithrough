...
import { isSoldOut } from "@/lib/shop-inventory";
...
export default async function ShopPage() {
  ...
  return (
    <ShopTabs
      ...
      items={items.map((i) => ({ id: i.id, title: i.title, description: i.description, priceInr: i.priceInr, imageUrl: i.imageUrl, stock: i.stock, featured: i.featured, hasSizes: i.hasSizes, soldOut: isSoldOut(i) }))}
    />
  );
}
